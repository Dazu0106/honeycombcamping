...
public class Server : MonoBehaviour {
    ...
    void Start () {
        ...
        {   //player[i] = GameObject.Find("Bullet"+i);
            UpdateTileColor(player[i],player[i].GetComponent<MovementController>().playertile);
        }
        ...
        if(texts.Count>0){
            ...
            if((dummyPlayer[0]==player[0]) || (dummyPlayer[1]==player[0]) || (dummyPlayer[2]==player[0]))//dummyplayerがplayer0であるをチェック
            {
                ...
                {    
                    ...
                    UpdateTileColor(player[0],player[0].GetComponent<MovementController>().playertile);
            ...
            if((dummyPlayer[0]==player[1]) || (dummyPlayer[1]==player[1]) || (dummyPlayer[2]==player[1]))
            {
                ...
                {    
                    ...
                    UpdateTileColor(player[1],player[1].GetComponent<MovementController>().playertile);
            ...
            if((dummyPlayer[0]==player[2]) || (dummyPlayer[1]==player[2]) || (dummyPlayer[2]==player[2]))
            {
                ...
                {    
                    ...
                    UpdateTileColor(player[2],player[2].GetComponent<MovementController>().playertile);
            ...
            if((dummyPlayer[0]==player[3]) || (dummyPlayer[1]==player[3]) || (dummyPlayer[2]==player[3]))
            {
                ...
                {    
                    ...
                    UpdateTileColor(player[3],player[3].GetComponent<MovementController>().playertile);
    ...
    public void UpdateTileColor(GameObject player,TileBase playertile)
    {   //var tilemap = GetComponent<Tilemap>();//Tilemapを取得
        ...
        Tilemap.SetTile( currentPlayerTile, playertile );//Tileのcolorをplayercolorに変更
